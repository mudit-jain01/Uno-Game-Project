...
export default function Roomselect(props) {
  ...
  return (
    <div className="roomselection" id={props.id}>
      ...
      <div className="join-a-room" id={props.id}>
        JOIN A ROOM
      </div>
      <a onClick={props.onclick} className="private">
        PRIVATE
      </a>
      <div id={props.id + "alert"}>
        <span className="do-you-wanna"></span>
        <h1>Do You Wanna...</h1>
        <a onClick={props.onclick} className="join">
          JOIN
        </a>
        <a onClick={props.onclick} className="create">
          CREATE
        </a>
      </div>
      <a onClick={props.onclick} className="public">
        PUBLIC
      </a>
      <div id={props.id + "alert"}>
        <span className="do-you-wanna"></span>
